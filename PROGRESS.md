...
|------|------|--------|------|------|----------|
| Task 1 | [技术栈选型与项目架构文档](.trae/specs/foundry-v1/tasks.md) | P0 | ✅ 已完成 | — | — |
| Task 2 | [核心数据模型规范文档（Task & Artifact）](.trae/specs/foundry-v1/tasks.md) | P0 | ✅ 已完成（v1.5 修订） | Task 1 | — |
| Task 3 | [Agent Executor 架构设计文档](.trae/specs/foundry-v1/tasks.md) | P0 | ✅ 已完成 | Task 2 | — |
...
| Task 7 | [Harness 集成方案设计文档](.trae/specs/foundry-v1/tasks.md) | P0 | ✅ 已完成 | Task 3, Task 5, Task 6 | — |
| Task 8 | [可复用流程模板文档](.trae/specs/foundry-v1/tasks.md) | P1 | ⬜ 待开始 | Task 7 | — |
...
| 第一版流程模板的具体场景 | Task 8 | ⬜ 待解决 | 需在流程模板文档中给出选择及理由 |
...
| 同步项 | 来源 | 目标 | 计划执行 | 状态 |
|--------|------|------|---------|------|
| RolledBack 状态同步到 Artifact 生命周期状态机 | Task 5 | Task 2 | Task 9 | ⬜ 待执行 |
